...
<html>
    ...
    <body>
        ...
        <div class="page-head_agile_info_w3l">
            <div class="container">
                <h3 style="color: #ac2925">Một chút về <span style="color: white">Cellphone X</span></h3>
                <!--/w3_short-->
            ...
            <div class="container">
                <div class="agile_ab_w3ls_info">
                    <div class="col-md-6 ab_pic_w3ls">
                        <img src="images/15green.jpg" alt=" " class="img-responsive" style="height: 650px" />
                    </div>
                    <div class="col-md-6 ab_pic_w3ls_text_info">
                        <h5>Cellphone X<span> shop</span> </h5>
                        <p> Cellphone X là cửa hàng chuyên cung cấp điện thoại di động và phụ kiện chính hãng.  </p>
                        <p> Mong rằng với sự đa dạng về mẫu mã và chất lượng sản phẩm, Cellphone X cam kết mang đến cho khách hàng trải nghiệm mua sắm tốt nhất và sở hữu những sản phẩm chất lượng, giúp bạn tự tin và nổi bật.
                        ...
                        <div class="col-md-5 sign-gd-two">
                            ...
                            <div class="w3-address">
                                ...
                                <div class="w3-address-grid">
                                    ...
                                    <div class="w3-address-right">
                                        <h6>Địa chỉ Email </h6>
                                        <p>Email : nhom9prj@gmail.com</a></p>
                                    </div>
                                    <div class="clearfix"> </div>
                                </div>
                                <div class="w3-address-grid">
