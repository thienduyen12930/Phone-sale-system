                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav menu__list">
                                    ...
                                    <li class=" menu__item"><a class="menu__link" href="about">CellphoneX</a></li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-sub_agile">
                        <div class="col-md-8 modal_body_left modal_body_left1">
                            <h3 class="agileinfo_sign">Đăng Nhập <span> iphone</span></h3>
        ...
        <div class="modal fade" id="myModal2" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modal-body-sub_agile">
                        <div class="col-md-8 modal_body_left modal_body_left1">
                            <h3 class="agileinfo_sign">Đăng kí <span>iphone</span></h3>
                            <form action="#" method="post">
                                <div class="styled-input agile-styled-input-top">
                                    <input type="text" name="Name" required="">
                                    <label>Tên Đăng Nhập</label>
            ...
            <div class="container" >
                <c:choose>
                    <c:when test="${sessionScope.cart == null||sessionScope.cart.size() == 0}">
                        <h1 style="text-align: center">"Bạn không có sản phẩm nào trong giỏ hàng."</h1><br/><br/><br/><br/><br/>
                    </c:when>
                    <c:otherwise>
                        <h3></h3>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${cart}" var="c">
                                    <c:set var="count" value="${count+c.value.product.price*c.value.quantity_cart}"/>
                        ...
                        <h3 style="text-align: center">Tổng Thanh Toán: <fmt:formatNumber maxFractionDigits="3" value="${count*1000}" type="number"> </fmt:formatNumber></h3><br/><br/><br/>
                        <c:set var="count" value="${count}" scope="session"/>
                        <div style="text-align: center"><a  href="check" class="btn btn-success w-25">Thanh toán</a></div>
                    </c:otherwise>
                </c:choose>
        ...
        <div class="footer">
            <div class="footer_agile_inner_info_w3l">
                <div class="col-md-3 footer-left">
                    <h2><a href="home"><span>Cell</span>phoen X </a></h2>
                ...
                <div class="col-md-9 footer-right">
                    <div class="sign-grds">
                        ...
                        <div class="col-md-5 sign-gd-two">
                            <h4>Liên Hệ <span>iphone</span></h4>
