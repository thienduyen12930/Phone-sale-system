...
<html>
    <head>
        <title>Contact : Cellphone X</title>
        <!--/tags -->
    ...
    <body>
        ...
        <div class="page-head_agile_info_w3l">
            <div class="container">
                <h3 style="color: #ac2925">Liên hệ Cellphone X<span style="color: black"> </span></h3>
                <!--/w3_short-->
                ...
                <div class="col-md-9 footer-right">
                    <div class="sign-grds">
                        <div class="col-md-4 sign-gd">
                            <h4>Thông tin <span>Cellphone X</span> </h4>
                            <ul>
                                <li><a href="home">Trang Chủ</a></li>
                                <li><a href="shop-now">shopping</a></li>
                        ...
                        <div class="col-md-5 sign-gd-two">
                            ...
                            <div class="w3-address">
                                ...
                                <div class="w3-address-grid">
                                    ...
                                    <div class="w3-address-right">
                                        <h6>Địa chỉ Email </h6>
                                        <p>Email :<a href="mailto:example@email.com"> nhom9prj@gmail.com</a></p>
                                    </div>
                                    <div class="clearfix"> </div>
                                </div>
                                <div class="w3-address-grid">
