        ...
        <div class="container body_createProduct">
            ...
            <div class="col-md-6 content_createProduct">
                <form action="create-product" method="post">
                    <h1 style="color: white; margin-bottom: 30px">Create product</h1>
                    <hr style="
                        height:1px;
                        background:black;
                        ">
                    <table>
                        ...
                        <tr>
                            <td class="title">Category_id:</td>
                            <td class="input"><select name="category_id" >
                        ...
                        <tr>
                            ...
                            <td class="input"><input  type="text" name="quantity" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title">Price:</td>
                            <td class="input"><input type="text" name="price" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title">Description:</td>
                            <td class="input"><input type="text" name="description" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title"> Image:</td>
                            <td class="input"><input type="text" name="imagine" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title">Image2:</td>
                            <td class="input"><input type="text" name="imagine2" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title">Image3:</td>
                            <td class="input"><input type="text" name="imagine3" value="" /></td>
                        </tr>
                        <tr>
                            <td class="title">Created_date</td>
                            <td class="input"> <input type="date" name="created-date" value="" /></td>
                        </tr>
                        <tr>
