...
<html>
    ...
    <body>
        ...
        <div class="page-head_agile_info_w3l">
            <div class="container">
                <h3 style="color: #ac2925">Danh sách tất cả sản phẩm <span> </span></h3>
                <!--/w3_short-->
        ...
        <div class="banner-bootom-w3-agileits">
            <div class="container" >
                ...
                <h1>List Product</h1><br/>
                <a href ="create-product"  style="color: white;" class="create-product">Create New</a><br/><br/>
                <style>
                    .create-product {
                ...
                <nav aria-label="Page navigation example" style="text-align: right" >
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${totalPage}" varStatus="i">
                            <li class="page-item"><a class="page-link" href="list-products?index=${i.index}">${i.index}</a></li>
                            </c:forEach>
